...
public abstract class AbstractSearchableService<Id extends Serializable, T extends BaseModel<Id>> extends AbstractService<Id, T> implements BaseSearchableService<Id, T> {
